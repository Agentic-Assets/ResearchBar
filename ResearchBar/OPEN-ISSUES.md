...
| Test `NSStatusItem` on macOS 26 (Tahoe) | **Resolved 2026-07-13.** The cap was invisible because macOS 26 Control Center's private `trackedApplications` admission store had attributed ResearchBar's status item to Cursor's disallowed entry (stale attribution from dev builds launched inside Cursor terminals); repaired via a backed-up plist edit plus a cfprefsd/Control Center restart, and upstream steipete/CodexBar PR #1954 (Tahoe no-window recovery) was ported (commit `98bc0d52`). Full record: [`../goals/2026-07-13-researchbar-menu-bar-icon-unresolved-issue.md`](../goals/2026-07-13-researchbar-menu-bar-icon-unresolved-issue.md) and [`../goals/2026-07-12-researchbar-menu-bar-icon-closeout.md`](../goals/2026-07-12-researchbar-menu-bar-icon-closeout.md). |
