...
const publicCountFiles = [
  ["docs/providers.md", `ResearchBar currently registers ${providerCount} provider IDs.`],
...
assert(
  readme.includes(`ResearchBar currently retains ${providerCount} inherited provider IDs.`),
  `README.md must advertise ${providerCount} inherited provider IDs`,
);
