...
final class CLIEntryTests: XCTestCase {
    ...
    func test_cliVersionFallsBackToContainingAppBundle() throws {
        ...
        let appURL = root.appendingPathComponent("ResearchBar.app", isDirectory: true)
        ...
        let helperURL = helpersURL.appendingPathComponent("ResearchBarCLI")
    ...
    func test_cliVersionFollowsSymlinkedHelper() throws {
        ...
        let symlinkURL = binURL.appendingPathComponent("researchbar")
    ...
    func test_cliVersionPrefersAdjacentVersionOverStandaloneBundleName() throws {
        ...
        let helperURL = binURL.appendingPathComponent("ResearchBarCLI")
        try Data().write(to: helperURL)
        try "4.5.6\n".write(
