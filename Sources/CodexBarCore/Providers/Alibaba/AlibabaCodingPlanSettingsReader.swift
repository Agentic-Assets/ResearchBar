    ...
    public var errorDescription: String? {
        ...
        case .missingToken:
            return "Alibaba Coding Plan API key not found. " +
                "Set apiKey in ~/.config/researchbar/config.json, ALIBABA_CODING_PLAN_API_KEY, " +
        ...
        case let .missingCookie(details):
            let base = "No Alibaba Coding Plan session cookies found in browsers. " +
                "If you use Safari, enable Full Disk Access for ResearchBar/Terminal or paste a manual Cookie header."
