...
public enum LLMProxyUsageError: LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingCredentials:
            "Missing LLM Proxy API key. Set apiKey in ~/.config/researchbar/config.json or LLM_PROXY_API_KEY."
        case .missingBaseURL:
            "Missing LLM Proxy base URL. Set enterpriseHost in ~/.config/researchbar/config.json or LLM_PROXY_BASE_URL."
        case .invalidURL:
