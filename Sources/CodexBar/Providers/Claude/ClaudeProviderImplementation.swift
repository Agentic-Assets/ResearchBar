...
struct ClaudeProviderImplementation: ProviderImplementation {
    ...
    func settingsToggles(context: ProviderSettingsContext) -> [ProviderSettingsToggleDescriptor] {
        let subtitle = if context.settings.debugDisableKeychainAccess {
            ...
            "Use /usr/bin/security to read Claude credentials and avoid ResearchBar keychain prompts."
        }
    ...
    func settingsFields(context: ProviderSettingsContext) -> [ProviderSettingsFieldDescriptor] {
        [
            ProviderSettingsFieldDescriptor(
                ...
                title: "Admin API key",
                subtitle: "Stored in ~/.config/researchbar/config.json. Requires an Anthropic Admin API key.",
                kind: .secure,
