...
so ResearchBar only needs a valid API key to show the current account balance.
...
ResearchBar uses the official Moonshot account and billing surface rather than unofficial
