...
## Widget types
- **ResearchBar Switcher** (`CodexBarSwitcherWidget`): static provider switcher widget, small/medium/large.
- **ResearchBar Usage** (`CodexBarUsageWidget`): configurable provider usage widget, small/medium/large.
- **ResearchBar History** (`CodexBarHistoryWidget`): configurable usage-history chart, medium/large.
- **ResearchBar Metric** (`CodexBarCompactWidget`): compact credits/today-cost/30-day-cost widget, small only.
